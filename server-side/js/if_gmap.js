...
var def_zoomval = 17;
var def_longval = 135.964415;
var def_latval = 34.983491;
...
function if_gmap_init()
{
	...
	google.maps.event.addListener(gmapdata, 'click', function(event) {
		document.getElementById("longtitude").value = event.latLng.lng().toFixed(6);
	...
	document.getElementById("longtitude").value = def_longval;
...
{
	var longval = document.getElementById("longtitude").value;
